...
public class DetailActivity extends AppCompatActivity {
    ...
    String recipeItemName, recipeItemMin, recipeDescription;
    String key = "";
    String compareKey = "";
    String recipeKey = "";
    String imageUrl = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (firebaseAuth.getCurrentUser() == null){
            ...
            if (mBundle != null) {
                ...
                recipeItemMin = mBundle.getString("price");
                recipePrice.setText(recipeItemMin);
    ...
    public void btnDislike(final View view) {
        ...
        FoodData fireStoreFoodData = new FoodData(recipeItemName,recipeDescription,recipeItemMin,imageUrl,key,favoriteKey);
